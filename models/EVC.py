...
# from .Function import Encoding, Mean, DropPath, Mlp, GroupNorm, LayerNormChannel, ConvBlock
...
class EVCBlock(nn.Module):
    def __init__(self, in_channels, out_channels, channel_ratio=4, base_channel=16):
        ...
        # LVC
        self.lvc = LVCBlock(in_channels=in_channels, out_channels=in_channels, num_codes=64)  # c1值暂时未定
        # LightMLPBlock
